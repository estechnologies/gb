...
<html lang="en">
<head>
 <title>Insurance coverage for your shipment</title>
  <meta charset="utf-8">
 ...
 <button class="btn btn-default dropdown-toggle"  type="button" data-toggle="dropdown">My Account
	...
	<div class="container" >
		...
		<i><h4>Cargo Insurance Exclusions:</h4></i>
			...
			<p> For experts Solutions, <a style="color:Orange;text-decoration: underline;"  href="contactus_user.php" >Click here</a>    to Contact us</p>
