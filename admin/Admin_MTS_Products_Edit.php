...
<body >
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  ...
  <div class="panel-body">
		 ...
		 <form class="form-horizontal" action="adminProductEditBack.php" method="post" enctype="multipart/form-data">
		  <center><?php 
  ...
  <div style="margin-bottom: 12px" id="lenghts" class="input-group">
									...
									<input type="hidden" name="id" value="<?php echo $row['productId']; ?>">
                                        ...
                                        <input  id="Productid" name="Productid" type="text" required="required" readonly oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);"  placeholder="Enter Product id" value="<?php echo $row['productId'];?>" class="form-control input-md">
  ...
  <div style="margin-bottom: 12px" id="lenghts" class="input-group">
									...
									<input type="hidden" name="id" value="<?php echo $row['productId']; ?>">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                        <input  id="productName" name="productName" type="text" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);"  maxlength="200" placeholder="Enter Product name" value="<?php echo $row['productname'];?>" class="form-control input-md">
 ...
 <label for="productCode">Product Code*</label>
                            <div style="margin-bottom: 12px" id="widths" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                       <input id="productCode" name="productCode" type="text" placeholder="Enter Product code" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);"  maxlength="50"  value="<?php echo $row['productcode'];?>" class="form-control input-md">
                                    </div>
 ...
 <label for="producDescription">Product Description*</label>
							...
							<span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                       <input id="producDescription" name="producDescription" type="text" placeholder="Enter Product description" maxlength="300" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);"   value="<?php echo $row['productdescription'];?>" class="form-control input-md">
                                    </div>
									<label for="dimensions">Dimensions*</label>
  <div style="margin-bottom: 12px" id="quantitys" class="input-group">
									 
                                       <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                        <input id="dimensions" name="dimensions" type="text" placeholder="Enter Dimensions in mm" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);" value="<?php echo $row['dimension'];?>" class="form-control input-md">
                            ...
                            <div style="margin-bottom: 12px" class="input-group">
                                       <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                        <input id="unitPrice" name="unitPrice" type="text" placeholder="Enter Unit Price" maxlength="10" value="<?php echo $row['unitprice'];?>" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);" class="form-control input-md">                         
  ...
  <div style="margin-bottom: 12px" class="input-group">
                                       ...
                                       <input id="MOQ" name="MOQ"  type="text" placeholder="Enter minimum order of quantity" maxlength="10" value="<?php echo $row['moq'];?>" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);" class="form-control input-md">
  ...
  <div style="margin-bottom: 12px" class="input-group">
                                       ...
                                       <span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                                       <input id="LeadTime" name="LeadTime" type="text" placeholder="Enter Lead time in days" maxlength="50" value="<?php echo $row['leadtime'];?>" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);" class="form-control input-md">
  ...
  <div style="margin-bottom: 12px" class="input-group">
									 <table id= "contactsno" name="contactsno">
												<tr>
													<td><input id="browser0" name="browser0" class="form-control" type="file"></td>
                                    ...
                                    <center><button  type="submit"  name="submit" id="submit" style="width:auto;" class="btn btn-default">Update Product</button></center>
