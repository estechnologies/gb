<?php
	...
	if($resultQuery == 1){
		header("Location:Admin_MTS_Bookings_Edit.php?id=$productbookingid&msg1=MTS Booking has been updated successfully.");
	}else{
		header("Location:Admin_MTS_Bookings_Edit.php?id=$productbookingid&msg=Failed MTS Booking Update");
	}
