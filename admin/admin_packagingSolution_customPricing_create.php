...
<html lang="en">
<head>
 <title>Create MTO Pricing</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default navbar-fixed-top">
  ...
  <center>  <div style="background-color: #EAE9E9;" class="panel-heading"><h3 class="panel-title"><strong>Add MTO Pricing</strong></h3>
  ...
  <center></center>
		 ...
		 <form action="adminCustomOrdersPriceCreateBack.php" method="post" enctype="multipart/form-data">
 ...
 <label for="Thickness">Thickness*</label>
  ...
  <div style="margin-bottom: 12px" class="input-group">
                                       ...
                                       <input id="Price" name="Price" type="text" placeholder="Enter Price in Rupees" value="" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);" maxlength="10" class="form-control input-md">
                                        
                               </div>
                                    <center><button  type="submit"  name="submit" id="submit" class="btn btn-default">Add Pricing</button></center>
