   ...
   <li style="margin-right:20px;margin-top:10px;"><a href="admin.php" class="navbar-btn btn-default btn pull-right"><span class="glyphicon glyphicon-home"></span> Home</a></li>
		...
		if($pageNumber == null or $pageNumber == '1'){
			...
			$pageNumber = ($pageNumber*5)-5;
											...
											?>
											 ...
											 <form name="search_form" method="POST" action="admin_packagingSolution_customOrders_view.php">
    ...
    <?php 
			...
			?>
							...
							<tr>
								<td><a href="admin_packagingSolution_customOrders_Edit.php?id=<?php echo $row['cdid'];?>">Edit</a></td>
        ...
        <!--
            ...
            <?php 
            	...
            	for($i = 1;$i <= $pageCount; $i++){
            		?>  <li><a href="admin_packagingSolution_customOrders_view.php?page=<?php echo $i;?>"><?php  echo $i; ?></a></li> <?php 
            	}
