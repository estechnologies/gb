	...
	<div class="container" style="margin-top: 100px;color:black;">
		...
		if($pageNumber == null or $pageNumber == '1'){
			...
			$pageNumber = ($pageNumber*5)-5;
											...
											<form name="search_form" method="POST" action="Admin_Service_Providers_view.php">
			...
			?>
											...
											<tr><td><a href="Admin_Service_Providers_Edit.php?id=<?php echo $row['service_id'];?>">Edit</a></td>
        ...
        <!--
            ...
            <?php 
            	...
            	for($i = 1;$i <= $pageCount; $i++){
            		?>  <li><a href="Admin_Service_Providers_view.php?page=<?php echo $i;?>"><?php  echo $i; ?></a></li> <?php 
            	}
