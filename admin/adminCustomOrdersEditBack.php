<?php 
		...
		if($resultQuery == 1){
			header("Location:admin_packagingSolution_customOrders_Edit.php?id=$cd&msg1=MTO Order has been updated successfully.");
		}else{
			header("Location:admin_packagingSolution_customOrders_Edit.php?id=$cd&msg=MTO Order has been updated UNsuccessfully.");
		}
