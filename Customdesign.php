...
<nav style="margin-top: 100px;"  class="navbar navbar-inverse">
  ...
  <div class="panel-body">
		 ...
		 <form action="packagingSolutionsFullBack.php" method="post" enctype="multipart/form-data"  >
		 <center><?php 
 ...
 <label for="Thickness">Thickness*</label>
  ...
  <div style="margin-bottom: 12px" id="quantitys" class="input-group">
                                        ...
                                        <input id="quantity" name="quantity" type="text" placeholder="Enter quantity" onfocusout="quantityzero();" class="form-control input-md">
