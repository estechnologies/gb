...
.btn:hover
{
 ...
 <button class="btn btn-default dropdown-toggle" style="font-size:18px" type="button" data-toggle="dropdown">My Account
  ...
  <div class="panel-body">
   <form id="Employee-form" action="userDashBoardPasswordReset.php" method="POST" role="form >
   	<center><?php 
  ...
  <div style="margin-bottom: 12px" class="input-group">
		...
		<input id="email" name="email" type="email" placeholder="Enter your email address" maxlength="50" readonly  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" oninvalid="InvalidMsgEmail(this);"   oninput="InvalidMsgEmail(this);"  value="<?php echo $_SESSION['id']['email'];?>"  class="form-control">                                     
  </div>
