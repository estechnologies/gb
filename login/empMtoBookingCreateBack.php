<?php
	...
	if($resultQuery == 1){
		header("Location:MTOBookingsCreate.php?msg1=Your order has been confirmed. Your Order Id is $cdid.<br>Our Executive will get in touch with you for order processing.");
	}else{
		header("Location:MTOBookingsCreate.php?msg=Custom design update failed. Please try again.");
	}	
