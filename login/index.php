...
if(isset($_SESSION['emp']['username']) and isset($_SESSION['username'])){
		header("Location:main.php");
}
...
<html lang="en">
<head>
 <title>GoodsCAB Admin Login</title>
  <meta charset="utf-8">
...
<div class="col-md-6">
  ...
  <center>  <div style="background-color: #EAE9E9;" class="panel-heading"><h3 class="panel-title"><strong>EMPLOYEE LOGIN</strong></h3>
      
  </div> </center> 
  
  <div class="panel-body">
<form id="Employee-form" action="loginproc.php" method="POST" role="form" style="display: block;">
 <center><?php 
  ...
  <div style="margin-bottom: 12px" class="input-group">
                                        ...
                                        <input type="text" name="username" id="username" oninvalid="InvalidMsgError(this);" required="required" oninput="InvalidMsgError(this); "  maxlength="50" class="form-control" placeholder="Enter username" >         
                                    </div>
