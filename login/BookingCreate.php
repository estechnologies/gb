...
}else if($_SESSION['emp']['createBookingAccess'] != '1' or $_SESSION['emp']['shipmentbookingAccess'] != '1'){
...
<!-- this page is used main page booking -->
...
<form role="form"  id="calculate-route" method="post" name="calculate-route" action="empBookingCreate.php">
<div class="col-md-6">
 ...
 <label for="Mobile Number">Mobile Number*</label>
                            <div style="margin-bottom: 12px" class="input-group">
                                        ...
                                        <input type="text"  oninvalid="InvalidMsg(this);" maxlength="10" oninput="InvalidMsg(this);" pattern="[0-9]{10}"  required="required" name="usrtel" id="usrtel" class="form-control"  placeholder="Enter mobile number" />                                    </div>
 ...
 <label for="travel time">Travel Time*</label>
                            ...
                            <div style="margin-bottom: 12px" class="input-group">
                                        <span class="input-group-addon"><img src="images/description.png"></img></span>
                                         <textarea class="form-control" required="required"  style="height:203px;" id="Marterial_Description" maxlength="200" name="Marterial_Description" placeholder="Enter material description"></textarea>                               </div>
                                         <div  style="color:black;margin-bottom: 12px;">
											By clicking on Book Now button, you will accept the <a href="Terms_Privacy.php" target="_blank" style="text-decoration:underline;color:blue">Terms and Privacy</a> .
					</div>
