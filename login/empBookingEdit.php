<?php
	...
	if($resultQuery == 1){
		header("Location:BookingEdit.php?id=$hasid&msg1=Booking information is updated successfully.");
	}else{
		header("Location:BookingEdit.php?id=$hasid&msg= Update Unsucessfull");
	}
