...
}else if($_SESSION['emp']['mtobookingeditAccess'] != '1'or $_SESSION['emp']['mtobookingAccess'] != '1' ){
 ...
 <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">My Account
	...
	<div class="container" style="margin-top: 100px;margin-bottom: 150px;color:black;">
		...
		if($pageNumber == null or $pageNumber == '1'){
			...
			$pageNumber = ($pageNumber*5)-5;
											...
											$query="SELECT * FROM customDesignOrders ORDER BY cdid DESC LIMIT $pageNumber,5";
											if(isset($_POST['search'])){
												...
												$query = "SELECT * FROM customDesignOrders WHERE cdid ='$search_term' LIMIT $pageNumber,5";
											
												$checkQuery= mysql_query($query);
												if(mysql_num_rows($checkQuery) <= 0){
													$noFound= "Entered Order Id is not found in our records.";
												}else{
													$noFound = "";
												}
											...
											$pagesTotalCount = "SELECT * FROM customDesignOrders";
											...
											?>
											 ...
											 <form name="search_form" method="POST" action="MTOBookingsView.php">
											 <div class="container" style="margin-top:20px;">
											 <h3 style="margin-bottom:20px;"><b>MTO Bookings list</b></h3>
												<div class="row">
												
													<div class="col-md-3">
													<div class="search">
											<input type="text" name="search_box" placeholder="Enter Order id"  oninvalid="InvalidMsg(this);" oninput="InvalidMsg(this);" required="required"class="form-control input-sm" maxlength="8"  />
											</div>
											</div>
											<div class="col-md-1">
    ...
    <?php 
			...
			?>
							...
							<tr>
								<td><a href="MTOBookingsEdit.php?id=<?php echo $row['cdid'];?>">Edit</a></td>
								 ...
								 <td><img src="http://www.goodscab.com/<?php echo checkImage($row['image0']);?>" class="img-thumbnail" style="width: 80px; height: 80px;"></td>
								 <td><img src="http://www.goodscab.com/<?php echo checkImage($row['image1']);?>" class="img-thumbnail" style="width: 80px; height: 80px;"></td>
							</tr>
        ...
        <!--
            ...
            <?php 
            	...
            	for($i = 1;$i <= $pageCount; $i++){
            		?>  <li><a href="MTOBookingsView.php?page=<?php echo $i;?>"><?php  echo $i; ?></a></li> <?php 
            	}
