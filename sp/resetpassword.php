...
.btn:hover
{
 ...
 <button class="btn btn-default dropdown-toggle" style="font-size:18px" type="button" data-toggle="dropdown">My Account
  ...
  <div style="margin-bottom: 12px" class="input-group">
		...
		<input id="email" name="email" type="email" placeholder="Enter your email address" maxlength="50" readonly  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" oninvalid="InvalidMsgEmail(this);"   oninput="InvalidMsgEmail(this);"  value="<?php echo  $_SESSION['service']['email_id']; ?>"  class="form-control">                                     
  </div>
  ...
  <div style="margin-bottom: 12px" class="input-group">
     ...
     <input type="password" minlength="5" maxlength="20" required name="oldPassword" id="password" tabindex="2" class="form-control" onpaste="return false;"  placeholder="Enter current password">			
	 </div>	
								
							 <label for="password">New Password*</label>
  <div style="margin-bottom: 12px" class="input-group">
      <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
     <input type="password" minlength="5" maxlength="20" required name="password1" id="password" tabindex="2" class="form-control" onpaste="return false;" placeholder="Enter new password ">

  </div>
   <label for="password">Confirm New Password*</label>
  <div style="margin-bottom: 12px" class="input-group">
      <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
      <input type="password" minlength="5" maxlength="20" required name="password2" id="password" tabindex="2" class="form-control" onpaste="return false;" placeholder="Re-enter new password">
  </div>
