...
if(j<2){
 ...
 function checkButton(){
   ...
   var browser0 = document.getElementById("browser0"),
        clone = browser0.cloneNode(true);
    
    fileopen.parentNode.replaceChild(clone,browser0);
}
...
<nav style="margin-top: 100px;"  class="navbar navbar-inverse">
  ...
  <center></center>
		 ...
		 <form action="packagingSolutionsUserFull.php" method="post" enctype="multipart/form-data">
		  <center><?php 
 ...
 <label for="Thickness">Thickness*</label>
                            <div style="margin-bottom: 12px" id="packsage" class="input-group">
                                        ...
                                        <select id="thickness" name="thickness" value="" required="required" oninvalid="InvalidMsgfill(this);"  oninput="InvalidMsgfill(this);" class="form-control">
  ...
  <div style="margin-bottom: 12px" class="input-group">
									 <table id= "contactsno" name="contactsno">
												<tr>
													<td><input id="browser0" name="browser0"  class="form-control" onfocusout="validate('browser0')" type="file"></td>
													<td><input type="button" name="addRow[0]" onclick="contact_number(1)" class="add" value='+' /></td><td><input type="button" value="x" onclick="delRow(this)"/></td>
												</tr>
  ...
  <div style="margin-bottom: 12px" id="quantitys" class="input-group">
                                        ...
                                        <input id="quantity" name="quantity" type="text" placeholder="Enter quantity"  onfocusout="quantityzero();getPrices()" class="form-control input-md">
  ...
  <div style="margin-bottom: 12px" class="input-group">
                                       ...
                                       <input type="email" maxlength="50" name="Email" id="Email"   min="1" required="required" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" oninvalid="InvalidMsgEmail(this);"  oninput="InvalidMsgEmail(this); " name="Email" id="Email"class="form-control" value="<?php echo $_SESSION['id']['email'];?>" placeholder="Enter email address" />
                                        
                                    </div>
 <label for="Mobile Number">Mobile Number*</label>
                            <div style="margin-bottom: 12px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                                        <input type="text"  oninvalid="InvalidMsg(this);" maxlength="10" oninput="InvalidMsg(this);" pattern="[0-9]{10}"  required="required" name="usrtel" id="usrtel" class="form-control" value="<?php echo $_SESSION['id']['mobile'];?>"  placeholder="Enter mobile number" />          
                            </div>
